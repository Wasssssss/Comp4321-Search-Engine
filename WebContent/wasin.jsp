...
<div id="header">
<h1>Powerful Search Engine - Lucky Search</h1>
...
<!-- <li><a href="http://localhost:8080/Cphase1/Katrina.jsp">Similar Page</a></li>
...
if(request.getParameter("txtname")!=null&& !request.getParameter("txtname"). isEmpty())
{
	...
	if(result.size() > 0){
		...
		for(int i = 0; i < result.size(); i++){
			...
			out.println("Score of Link In Result Ranking: "+"<tr><td valign=\"top\">"+temp.getScore()+"</td>");
			out.println("<td>");
